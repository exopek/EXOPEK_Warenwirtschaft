...
abstract class $OrderCopyWith<$Res> {
  ...
  $Res call(
      ...
      String status,
      String total,
      @JsonKey(name: 'line_items') List<Product> products});
}
...
class _$_Order implements _Order {
  _$_Order(
      ...
      required this.total,
      @JsonKey(name: 'line_items') required final List<Product> products})
      : _products = products;
...
// *snake_case* to our Dart variable that uses *camelCase*
  ...
  @override
  String toString() {
    return 'Order(id: $id, status: $status, total: $total, products: $products)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, status, total,
